...
if __name__ == "__main__":
    ...
    block_materials = ['glass', 'ice', 'rubber', 'steel', 'wood']
    block_vec = {}
    for block_m in block_materials:
        train_data = load_dataset(modalities=args.modalities, dirs="../DATASET/EXP/BY_BLOCK/64_64_rgb_" + block_m + ".pt")
        ...
        block_vec[block_m] = block_material.tolist()
    file = open("./experiment2-block.p", 'wb')
    pickle.dump(block_vec, file)
    file.close()
